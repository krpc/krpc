...
std::string encode(double value) {
  ...
  pb::io::CodedOutputStream::WriteLittleEndian64ToArray(value2, reinterpret_cast<pb::uint8*>(const_cast<char*>(&data[0])));
  return data;
}
...
std::string encode(float value) {
  ...
  pb::io::CodedOutputStream::WriteLittleEndian32ToArray(value2, reinterpret_cast<pb::uint8*>(const_cast<char*>(&data[0])));
  return data;
}
...
std::string encode(pb::int32 value) {
  ...
  pb::io::CodedOutputStream::WriteVarint32ToArray(zigZagValue, reinterpret_cast<pb::uint8*>(const_cast<char*>(&data[0])));
  return data;
}
...
std::string encode(pb::int64 value) {
  ...
  std::string data(length, 0);
  pb::io::CodedOutputStream::WriteVarint64ToArray(zigZagValue, reinterpret_cast<pb::uint8*>(const_cast<char*>(&data[0])));
  return data;
}
...
std::string encode(pb::uint32 value) {
  ...
  std::string data(length, 0);
  pb::io::CodedOutputStream::WriteVarint32ToArray(value, reinterpret_cast<pb::uint8*>(const_cast<char*>(&data[0])));
  return data;
}
...
std::string encode(pb::uint64 value) {
  ...
  std::string data(length, 0);
  pb::io::CodedOutputStream::WriteVarint64ToArray(value, reinterpret_cast<pb::uint8*>(const_cast<char*>(&data[0])));
  return data;
}
...
std::string encode(const std::string& value) {
  ...
  pb::io::CodedOutputStream::WriteVarint64ToArray(length, reinterpret_cast<pb::uint8*>(const_cast<char*>(&data[0])));
  pb::io::CodedOutputStream::WriteStringToArray(value, reinterpret_cast<pb::uint8*>(const_cast<char*>(&data[header_length])));
  return data;
}
...
std::string encode_message_with_size(const pb::Message& message) {
  size_t length = static_cast<size_t>(message.ByteSize());
  size_t header_length = static_cast<size_t>(pb::io::CodedOutputStream::VarintSize64(length));
  std::string data(header_length + length, 0);
  pb::io::CodedOutputStream::WriteVarint64ToArray(length, reinterpret_cast<pb::uint8*>(const_cast<char*>(&data[0])));
  if (!message.SerializeWithCachedSizesToArray(reinterpret_cast<pb::uint8*>(const_cast<char*>(&data[header_length]))))
