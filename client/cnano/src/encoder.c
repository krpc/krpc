...
bool krpc_encode_callback_cstring(pb_ostream_t* stream, const pb_field_t* field, void* const* arg) {
...
static bool krpc_encode_callback_arguments(pb_ostream_t* stream, const pb_field_t* field,
                                           void* const* arg) {
...
krpc_error_t krpc_call(krpc_call_t* call, uint32_t serviceId, uint32_t procedureId,
...
krpc_error_t krpc_add_argument(krpc_call_t* call, uint32_t position,
...
bool krpc_encode_callback_double(pb_ostream_t* stream, const pb_field_t* field, void* const* arg) {
  if (!pb_encode_tag_for_field(stream, field))
    KRPC_CALLBACK_RETURN_ERROR("encoding tag for double");
  double* value = (double*)(*arg);
  if (!pb_encode_varint(stream, 8)) KRPC_CALLBACK_RETURN_ERROR("encoding size for double");
  KRPC_CALLBACK_RETURN_ON_ERROR(krpc_encode_double(stream, *value));
  return true;
}

bool krpc_encode_callback_float(pb_ostream_t* stream, const pb_field_t* field, void* const* arg) {
  if (!pb_encode_tag_for_field(stream, field)) KRPC_CALLBACK_RETURN_ERROR("encoding tag for float");
  float* value = (float*)(*arg);
  if (!pb_encode_varint(stream, 4)) KRPC_CALLBACK_RETURN_ERROR("encoding size for float");
  KRPC_CALLBACK_RETURN_ON_ERROR(krpc_encode_float(stream, *value));
  return true;
}

bool krpc_encode_callback_int32(pb_ostream_t* stream, const pb_field_t* field, void* const* arg) {
  if (!pb_encode_tag_for_field(stream, field)) KRPC_CALLBACK_RETURN_ERROR("encoding tag for int32");
  int32_t* value = (int32_t*)(*arg);
  size_t size;
  KRPC_CALLBACK_RETURN_ON_ERROR(krpc_encode_size_int32(&size, *value));
  if (!pb_encode_varint(stream, size)) KRPC_CALLBACK_RETURN_ERROR("encoding size for int32");
  KRPC_CALLBACK_RETURN_ON_ERROR(krpc_encode_int32(stream, *value));
  return true;
}

bool krpc_encode_callback_int64(pb_ostream_t* stream, const pb_field_t* field, void* const* arg) {
  if (!pb_encode_tag_for_field(stream, field)) KRPC_CALLBACK_RETURN_ERROR("encoding tag for int64");
  int64_t* value = (int64_t*)(*arg);
  size_t size;
  KRPC_CALLBACK_RETURN_ON_ERROR(krpc_encode_size_int64(&size, *value));
  if (!pb_encode_varint(stream, size)) KRPC_CALLBACK_RETURN_ERROR("encoding size for int64");
  KRPC_CALLBACK_RETURN_ON_ERROR(krpc_encode_int64(stream, *value));
  return true;
}

bool krpc_encode_callback_uint32(pb_ostream_t* stream, const pb_field_t* field, void* const* arg) {
  if (!pb_encode_tag_for_field(stream, field))
  ...
  if (!pb_encode_varint(stream, size)) KRPC_CALLBACK_RETURN_ERROR("encoding size for uint32");
  KRPC_CALLBACK_RETURN_ON_ERROR(krpc_encode_uint32(stream, *value));
  return true;
}

bool krpc_encode_callback_uint64(pb_ostream_t* stream, const pb_field_t* field, void* const* arg) {
  if (!pb_encode_tag_for_field(stream, field))
  ...
  if (!pb_encode_varint(stream, size)) KRPC_CALLBACK_RETURN_ERROR("encoding size for uint64");
  KRPC_CALLBACK_RETURN_ON_ERROR(krpc_encode_uint64(stream, *value));
  return true;
}

bool krpc_encode_callback_bool(pb_ostream_t* stream, const pb_field_t* field, void* const* arg) {
  if (!pb_encode_tag_for_field(stream, field)) KRPC_CALLBACK_RETURN_ERROR("encoding tag for bool");
  bool* value = (bool*)(*arg);
  size_t size;
  KRPC_CALLBACK_RETURN_ON_ERROR(krpc_encode_size_bool(&size, *value));
  if (!pb_encode_varint(stream, size)) KRPC_CALLBACK_RETURN_ERROR("encoding size for bool");
  KRPC_CALLBACK_RETURN_ON_ERROR(krpc_encode_bool(stream, *value));
  return true;
}

bool krpc_encode_callback_object(pb_ostream_t* stream, const pb_field_t* field, void* const* arg) {
  if (!pb_encode_tag_for_field(stream, field))
  ...
  if (!pb_encode_varint(stream, size)) KRPC_CALLBACK_RETURN_ERROR("encoding size for object");
  KRPC_CALLBACK_RETURN_ON_ERROR(krpc_encode_object(stream, *value));
  return true;
}

bool krpc_encode_callback_enum(pb_ostream_t* stream, const pb_field_t* field, void* const* arg) {
  if (!pb_encode_tag_for_field(stream, field)) KRPC_CALLBACK_RETURN_ERROR("encoding tag for enum");
  krpc_enum_t* value = (krpc_enum_t*)(*arg);
  size_t size;
  KRPC_CALLBACK_RETURN_ON_ERROR(krpc_encode_size_enum(&size, *value));
  if (!pb_encode_varint(stream, size)) KRPC_CALLBACK_RETURN_ERROR("encoding size for enum");
...
bool krpc_encode_callback_string(pb_ostream_t* stream, const pb_field_t* field, void* const* arg) {
  if (!pb_encode_tag_for_field(stream, field))
  ...
  if (!pb_encode_varint(stream, size)) KRPC_CALLBACK_RETURN_ERROR("encoding size for string");
  KRPC_CALLBACK_RETURN_ON_ERROR(krpc_encode_string(stream, value));
  return true;
}

bool krpc_encode_callback_bytes(pb_ostream_t* stream, const pb_field_t* field, void* const* arg) {
  if (!pb_encode_tag_for_field(stream, field)) KRPC_CALLBACK_RETURN_ERROR("encoding tag for bytes");
  ...
  if (!pb_encode_varint(stream, size)) KRPC_CALLBACK_RETURN_ERROR("encoding size for bytes");
...
krpc_error_t krpc_encode_message_ProcedureCall(pb_ostream_t* stream,
                                               const krpc_schema_ProcedureCall* value) {
...
krpc_error_t krpc_encode_message_Tuple(pb_ostream_t* stream, const krpc_schema_Tuple* value) {
  if (!pb_encode(stream, krpc_schema_Tuple_fields, value))
    KRPC_RETURN_STREAM_ERROR(ENCODING_FAILED, "failed to encode Tuple", stream);
  return KRPC_OK;
}

krpc_error_t krpc_encode_message_List(pb_ostream_t* stream, const krpc_schema_List* value) {
  if (!pb_encode(stream, krpc_schema_List_fields, value))
    KRPC_RETURN_STREAM_ERROR(ENCODING_FAILED, "failed to encode List", stream);
  return KRPC_OK;
}

krpc_error_t krpc_encode_message_Set(pb_ostream_t* stream, const krpc_schema_Set* value) {
  if (!pb_encode(stream, krpc_schema_Set_fields, value))
    KRPC_RETURN_STREAM_ERROR(ENCODING_FAILED, "failed to encode Set", stream);
  return KRPC_OK;
}

krpc_error_t krpc_encode_message_Dictionary(pb_ostream_t* stream,
                                            const krpc_schema_Dictionary* value) {
...
krpc_error_t krpc_encode_message_DictionaryEntry(pb_ostream_t* stream,
                                                 const krpc_schema_DictionaryEntry* value) {
...
krpc_error_t krpc_encode_size_message_ProcedureCall(size_t* size,
                                                    const krpc_schema_ProcedureCall* value) {
  pb_ostream_t stream = PB_OSTREAM_SIZING;
...
krpc_error_t krpc_encode_size_message_Tuple(size_t* size, const krpc_schema_Tuple* value) {
  pb_ostream_t stream = PB_OSTREAM_SIZING;
...
krpc_error_t krpc_encode_size_message_List(size_t* size, const krpc_schema_List* value) {
  pb_ostream_t stream = PB_OSTREAM_SIZING;
...
krpc_error_t krpc_encode_size_message_Set(size_t* size, const krpc_schema_Set* value) {
  pb_ostream_t stream = PB_OSTREAM_SIZING;
...
krpc_error_t krpc_encode_size_message_Dictionary(size_t* size,
                                                 const krpc_schema_Dictionary* value) {
  pb_ostream_t stream = PB_OSTREAM_SIZING;
...
krpc_error_t krpc_encode_size_message_DictionaryEntry(size_t* size,
                                                      const krpc_schema_DictionaryEntry* value) {
  pb_ostream_t stream = PB_OSTREAM_SIZING;
...
bool krpc_encode_callback_message_ProcedureCall(pb_ostream_t* stream, const pb_field_t* field,
                                                void* const* arg) {
  if (!pb_encode_tag_for_field(stream, field))
...
bool krpc_encode_callback_message_Tuple(pb_ostream_t* stream, const pb_field_t* field,
                                        void* const* arg) {
  if (!pb_encode_tag_for_field(stream, field)) KRPC_CALLBACK_RETURN_ERROR("encoding tag for Tuple");
  krpc_schema_Tuple* value = (krpc_schema_Tuple*)(*arg);
  size_t size;
  KRPC_CALLBACK_RETURN_ON_ERROR(krpc_encode_size_message_Tuple(&size, value));
  if (!pb_encode_varint(stream, size)) KRPC_CALLBACK_RETURN_ERROR("encoding size for Tuple");
  KRPC_CALLBACK_RETURN_ON_ERROR(krpc_encode_message_Tuple(stream, value));
  return true;
}

bool krpc_encode_callback_message_List(pb_ostream_t* stream, const pb_field_t* field,
                                       void* const* arg) {
  if (!pb_encode_tag_for_field(stream, field)) KRPC_CALLBACK_RETURN_ERROR("encoding tag for List");
  krpc_schema_List* value = (krpc_schema_List*)(*arg);
  size_t size;
  KRPC_CALLBACK_RETURN_ON_ERROR(krpc_encode_size_message_List(&size, value));
  if (!pb_encode_varint(stream, size)) KRPC_CALLBACK_RETURN_ERROR("encoding size for List");
  KRPC_CALLBACK_RETURN_ON_ERROR(krpc_encode_message_List(stream, value));
  return true;
}

bool krpc_encode_callback_message_Set(pb_ostream_t* stream, const pb_field_t* field,
                                      void* const* arg) {
  if (!pb_encode_tag_for_field(stream, field)) KRPC_CALLBACK_RETURN_ERROR("encoding tag for Set");
  krpc_schema_Set* value = (krpc_schema_Set*)(*arg);
  size_t size;
  KRPC_CALLBACK_RETURN_ON_ERROR(krpc_encode_size_message_Set(&size, value));
  if (!pb_encode_varint(stream, size)) KRPC_CALLBACK_RETURN_ERROR("encoding size for Set");
  KRPC_CALLBACK_RETURN_ON_ERROR(krpc_encode_message_Set(stream, value));
  return true;
}

bool krpc_encode_callback_message_Dictionary(pb_ostream_t* stream, const pb_field_t* field,
                                             void* const* arg) {
  if (!pb_encode_tag_for_field(stream, field))
  ...
  if (!pb_encode_varint(stream, size)) KRPC_CALLBACK_RETURN_ERROR("encoding size for Dictionary");
  KRPC_CALLBACK_RETURN_ON_ERROR(krpc_encode_message_Dictionary(stream, value));
  return true;
}

bool krpc_encode_callback_message_DictionaryEntry(pb_ostream_t* stream, const pb_field_t* field,
                                                  void* const* arg) {
  if (!pb_encode_tag_for_field(stream, field))
