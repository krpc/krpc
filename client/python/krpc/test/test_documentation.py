...
class TestDocumentation(ServerTestCase, unittest.TestCase):
    ...
    def test_basic(self) -> None:
        ...
        self.check_doc(
            "Procedure documentation string.", self.conn.test_service.float_to_string
        )
        self.check_doc(
        ...
        self.check_doc("Enum documentation string.", self.conn.test_service.TestEnum)
        self.check_doc(
            "Enum ValueA documentation string.", self.conn.test_service.TestEnum.value_a
        )
        self.check_doc(
            "Enum ValueB documentation string.", self.conn.test_service.TestEnum.value_b
        )
        self.check_doc(
