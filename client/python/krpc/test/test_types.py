...
class TestTypes(unittest.TestCase):
    ...
    def check_protobuf_type(self, code, service, name, numtypes, protobuf_type):
    ...
    def test_class_types(self):
        ...
        self.check_protobuf_type(Type.CLASS, 'ServiceName', 'ClassName', 0, typ.protobuf_type)
    ...
    def test_enumeration_types(self):
        ...
        self.check_protobuf_type(Type.ENUMERATION, 'ServiceName', 'EnumName', 0, typ.protobuf_type)
        typ.set_values({
            'a': {'value': 0, 'doc': 'doca'},
            'b': {'value': 42, 'doc': 'docb'},
