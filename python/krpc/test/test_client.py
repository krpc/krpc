...
class TestClient(unittest.TestCase):
    ...
    def test_named_parameters(self):
        self.assertEqual('1234', self.ksp.test_service.optional_arguments(x='1', y='2', z='3', another_parameter='4'))
        self.assertEqual('2413', self.ksp.test_service.optional_arguments(z='1', x='2', another_parameter='3', y='4'))
        self.assertEqual('1243', self.ksp.test_service.optional_arguments('1', '2', another_parameter='3', z='4'))
        self.assertEqual('123baz', self.ksp.test_service.optional_arguments('1', '2', z='3'))
        self.assertEqual('12bar3', self.ksp.test_service.optional_arguments('1', '2', another_parameter='3'))
        self.assertRaises(TypeError, self.ksp.test_service.optional_arguments, '1', '2', '3', '4', another_parameter='5')
