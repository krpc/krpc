...
class TestEncoder(unittest.TestCase):
    ...
    def test_rpc_hello_message(self):
        ...
        self.assertEqual (b'48454c4c4f2d525043000000', binascii.hexlify(message))

    def test_stream_hello_message(self):
        message = Encoder.STREAM_HELLO_MESSAGE
        self.assertEqual (12, len(message))
        self.assertEqual (b'48454c4c4f2d53545245414d', binascii.hexlify(message))

    def test_client_name(self):
        message = Encoder.client_name('foo')
        self.assertEqual (32, len(message))
        self.assertEqual (b'666f6f'+b'00'*29, binascii.hexlify(message))

    def test_empty_client_name(self):
        message = Encoder.client_name()
        self.assertEqual (32, len(message))
        self.assertEqual (b'00'*32, binascii.hexlify(message))

    def test_long_client_name(self):
        message = Encoder.client_name('a'*33)
        self.assertEqual (32, len(message))
        self.assertEqual (b'61'*32, binascii.hexlify(message))
    ...
    def test_encode_message(self):
        ...
        expected = b'0a0b536572766963654e616d65120d50726f6365647572654e616d65'
        self.assertEqual(expected, binascii.hexlify(data))

    def test_encode_value(self):
        data = Encoder.encode(300, Types().as_type('int32'))
        self.assertEqual(b'ac02', binascii.hexlify(data))
    ...
    def test_encode_message_delimited(self):
        ...
        expected = b'1c'+b'0a0b536572766963654e616d65120d50726f6365647572654e616d65'
        self.assertEqual(expected, binascii.hexlify(data))

    def test_encode_value_delimited(self):
        data = Encoder.encode_delimited(300, Types().as_type('int32'))
        self.assertEqual(b'02'+b'ac02', binascii.hexlify(data))
    ...
    def test_encode_class_none(self):
        ...
        value = None
        data = Encoder.encode(value, typ)
        self.assertEqual(b'00', binascii.hexlify(data))
