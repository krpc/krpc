...
{
    sealed class StreamClient : IClient<byte,StreamResponse>
    {
        ...
        public IStream<byte,StreamResponse> Stream { get; private set; }
        ...
        public bool Equals (IClient<byte,StreamResponse> other)
        {
