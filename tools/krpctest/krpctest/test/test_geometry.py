...
class TestGeometry(krpctest.TestCase):
    ...
    def test_normalize(self):
        ...
        self.assertAlmostEqual((1/math.sqrt(2), 1/math.sqrt(2), 0), normalize((1, 1, 0)))
        self.assertAlmostEqual((1/math.sqrt(2), 0, 1/math.sqrt(2)), normalize((1, 0, 1)))
    ...
    def test_quaternion_conjugate(self):
        self.assertAlmostEqual((-1, -2, -3, 4), quaternion_conjugate((1, 2, 3, 4)))

    def test_quaternion_mult(self):
        self.assertAlmostEqual((24, 48, 48, -6), quaternion_mult((1, 2, 3, 4), (5, 6, 7, 8)))
        self.assertAlmostEqual((40, 16, -35, -27), quaternion_mult((5, 1, 0, -2), (3, -6, 1, 9)))
