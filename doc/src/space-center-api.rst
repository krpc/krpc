...
.. toctree::
   ...
   python-api/space-center/space-center
   python-api/space-center/vessel
   python-api/space-center/celestial-body
   ...
   python-api/space-center/auto-pilot
   python-api/space-center/geometry-types
