    ...
    try:
        ...
        while True:
            ...
            if current is None:
                ...
                velocity = target.part.vessel.velocity(current.reference_frame)
                ...
                stdscr.addstr(10, 0, 'DST     % 4.2f m' % distance)
                stdscr.addstr(10,20, 'SPD     % 4.2f m/s' % speed)
                stdscr.addstr(11, 0, 'AXI DST % 4.2f m' % axial_distance)
                stdscr.addstr(11,20, 'AXI VEL % 4.2f m/s' % axial_speed)
                stdscr.addstr(12, 0, 'RAD DST % 4.2f m' % radial_distance)
                stdscr.addstr(12,20, 'RAD VEL % 4.2f m/s' % radial_speed)
