...
namespace KRPC.Service.KRPC
{
    ...
    /// </summary>
    static class ExpressionTreePrinter
    {
        /// <summary>
        /// Render the expression tree as an indented multi-line string.
        /// </summary>
        internal static string Print (LinqExpression expression)
        {
        ...
        sealed class Printer
        {
            ...
            public void PrintNode (LinqExpression expression, int depth)
            {
                ...
                // A node kind with no specific rendering above is printed without
                // its children, so an unexpected node is visible in the dump
