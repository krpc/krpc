...
namespace KRPC.Service.KRPC
{
    ...
    public class Type : Equatable<Type>
    {
        ...
        // A nullable value is described by the type it holds, because a null travels
        // beside the value on the wire rather than inside it
        System.Type DescribedType {
            get { return System.Nullable.GetUnderlyingType (InternalType) ?? InternalType; }
        }
        ...
        public static Type TupleType (IList<Type> valueTypes)
        {
            ...
            if (valueTypes.Count > TypeUtils.MaxTupleElements)
                throw new ArgumentException (
