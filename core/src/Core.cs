...
namespace KRPC
{
    ...
    public sealed class Core
    {
        ...
        /// <summary>
        /// Whether a client held the tick during the update that just ran. An update that was
        /// held took as long as the client it was waiting for, which is not a measurement the
        /// frame rate should be adapted to.
        /// </summary>
        bool heldTick;
        ...
        /// executed in this tick rather than in later ones.
        /// </summary>
