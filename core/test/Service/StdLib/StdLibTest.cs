...
namespace KRPC.Test.Service.StdLib
{
    ...
    public class StdLibTest
    {
        ...
        {
            // Each rule differs only in where it sends a halfway value
            Assert.AreEqual (2, global::KRPC.Service.StdLib.StdLib.Round (2.5));
            Assert.AreEqual (-2, global::KRPC.Service.StdLib.StdLib.Round (-2.5));
            Assert.AreEqual (3, global::KRPC.Service.StdLib.StdLib.RoundHalfAwayFromZero (2.5));
            Assert.AreEqual (-3, global::KRPC.Service.StdLib.StdLib.RoundHalfAwayFromZero (-2.5));
            Assert.AreEqual (3, global::KRPC.Service.StdLib.StdLib.RoundHalfUp (2.5));
            Assert.AreEqual (-2, global::KRPC.Service.StdLib.StdLib.RoundHalfUp (-2.5));
            Assert.AreEqual (3, global::KRPC.Service.StdLib.StdLib.Round (2.6));
            Assert.AreEqual (2, global::KRPC.Service.StdLib.StdLib.Round (2.4));
        }

        [Test]
        public void RoundingToDecimalPlaces ()
        {
            Assert.AreEqual (0.62, global::KRPC.Service.StdLib.StdLib.Round (0.625, 2), 1e-10);
            Assert.AreEqual (
                0.63,
                global::KRPC.Service.StdLib.StdLib.RoundHalfAwayFromZero (0.625, 2), 1e-10);
            Assert.AreEqual (
                0.63, global::KRPC.Service.StdLib.StdLib.RoundHalfUp (0.625, 2), 1e-10);
            // Negative places round to tens and hundreds
            Assert.AreEqual (1200, global::KRPC.Service.StdLib.StdLib.Round (1235, -2));
            Assert.AreEqual (
                1300,
                global::KRPC.Service.StdLib.StdLib.RoundHalfAwayFromZero (1250, -2));
            Assert.AreEqual (1300, global::KRPC.Service.StdLib.StdLib.RoundHalfUp (1250, -2));
            // A double has no digits left to round beyond fifteen places, and nothing
            // survives rounding to fewer than the smallest it holds
            Assert.AreEqual (1.5, global::KRPC.Service.StdLib.StdLib.Round (1.5, 20));
            Assert.AreEqual (0, global::KRPC.Service.StdLib.StdLib.Round (1.5, -400));
            Assert.AreEqual (0, global::KRPC.Service.StdLib.StdLib.RoundHalfUp (1.5, -400));
        }
        ...
        {
            Assert.AreEqual (1, global::KRPC.Service.StdLib.StdLib.Log (Math.E), 1e-10);
            Assert.AreEqual (3, global::KRPC.Service.StdLib.StdLib.Log (8, 2), 1e-10);
            Assert.AreEqual (2, global::KRPC.Service.StdLib.StdLib.Log (100, 10), 1e-10);
        }
