...
function TestAttributes:test_get_parameter_type_attributes()
  luaunit.assertEquals(List{}, Attributes.get_parameter_type_attrs(0, List{}))
  luaunit.assertEquals(List{}, Attributes.get_parameter_type_attrs(0, List{'Class.Method(ServiceName.ClassName,MethodName)'}))
  luaunit.assertEquals(List{}, Attributes.get_parameter_type_attrs(0, List{'ReturnType.Class(ServiceName.ClassName)'}))
  luaunit.assertEquals(List{}, Attributes.get_parameter_type_attrs(0, List{'Class.Method(ServiceName.ClassName,MethodName)', 'ReturnType.Class(ServiceName.ClassName)'}))
  luaunit.assertEquals(List{}, Attributes.get_parameter_type_attrs(1, List{'ParameterType(2).Class(ServiceName.ClassName)'}))
  luaunit.assertEquals(List{'Class(ServiceName.ClassName)'}, Attributes.get_parameter_type_attrs(2, List{'ParameterType(2).Class(ServiceName.ClassName)'}))
  luaunit.assertEquals(List{'Class(ServiceName.ClassName2)'}, Attributes.get_parameter_type_attrs(2, List{'ParameterType(0).Class(ServiceName.ClassName1)', 'ParameterType(2).Class(ServiceName.ClassName2)'}))
  luaunit.assertEquals(List{'Class(ServiceName.ClassName)'}, Attributes.get_parameter_type_attrs(1, List{'Class.Method(ServiceName.ClassName,MethodName)', 'ParameterType(1).Class(ServiceName.ClassName)'}))
  luaunit.assertEquals(List{'List(string)'}, Attributes.get_parameter_type_attrs(1, List{'ParameterType(1).List(string)'}))
  luaunit.assertEquals(List{'Dictionary(int32,string)'}, Attributes.get_parameter_type_attrs(1, List{'ParameterType(1).Dictionary(int32,string)'}))
  luaunit.assertEquals(List{'Set(string)'}, Attributes.get_parameter_type_attrs(1, List{'ParameterType(1).Set(string)'}))
  luaunit.assertEquals(List{'List(Dictionary(int32,string))'}, Attributes.get_parameter_type_attrs(1, List{'ParameterType(1).List(Dictionary(int32,string))'}))
  luaunit.assertEquals(List{'Dictionary(int32,List(ServiceName.ClassName))'}, Attributes.get_parameter_type_attrs(1, List{'ParameterType(1).Dictionary(int32,List(ServiceName.ClassName))'}))
end
