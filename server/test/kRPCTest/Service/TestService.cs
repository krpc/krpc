...
namespace KRPCTest.Service
{
    ...
    public static class TestService
    {
        ...
        /// </summary>
        [KRPCProcedure]
        public static void ProcedureSingleArgNoReturn (Krpc.Response data)
        {
            Service.ProcedureSingleArgNoReturn (data);
        }

        [KRPCProcedure]
        public static void ProcedureThreeArgsNoReturn (Krpc.Response x,
                                                       Krpc.Request y, Krpc.Response z)
        {
            Service.ProcedureThreeArgsNoReturn (x, y, z);
        }

        [KRPCProcedure]
        public static Krpc.Response ProcedureNoArgsReturns ()
        {
            return Service.ProcedureNoArgsReturns ();
        }

        [KRPCProcedure]
        public static Krpc.Response ProcedureSingleArgReturns (Krpc.Response data)
        {
