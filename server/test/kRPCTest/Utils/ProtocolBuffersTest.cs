...
namespace KRPCTest.Utils
{
    ...
    public class ProtocolBuffersTest
    {
        ...
        {
            Assert.AreEqual ("Krpc.Request", ProtocolBuffers.GetMessageTypeName (typeof(Krpc.Request)));
            Assert.AreEqual ("Krpc.Response", ProtocolBuffers.GetMessageTypeName (typeof(Krpc.Response)));
        ...
        public void GetEnumTypeName ()
        {
            ...
            Assert.Throws<ArgumentException> (() => ProtocolBuffers.GetEnumTypeName (typeof(Krpc.Request)));
        ...
        public void GetValueTypeName ()
        {
            ...
            Assert.Throws<ArgumentException> (() => ProtocolBuffers.GetValueTypeName (typeof(Krpc.Request)));
            Assert.Throws<ArgumentException> (() => ProtocolBuffers.GetValueTypeName (typeof(Krpc.Response)));
        ...
        //        [Test]
        //        public void ParserForMessageType ()
        //        {
        //            Assert.AreEqual (typeof(Krpc.Request.Parser),
        //                ProtocolBuffers.ParserForMessageType (typeof(Krpc.Request)).GetType ());
        //            Assert.AreEqual (typeof(Krpc.Response.Parser),
        //                ProtocolBuffers.ParserForMessageType (typeof(Krpc.Response)).GetType ());
        //            Assert.Throws<ArgumentException> (() => ProtocolBuffers.ParserForMessageType (null));
        //            Assert.Throws<ArgumentException> (() => ProtocolBuffers.ParserForMessageType (typeof(string)));
        //            Assert.Throws<ArgumentException> (() => ProtocolBuffers.ParserForMessageType (typeof(ProtocolBuffersTest)));
        //        }

        [Test]
        public void IsAMessageType ()
        {
            Assert.IsTrue (ProtocolBuffers.IsAMessageType (typeof(Krpc.Request)));
            Assert.IsTrue (ProtocolBuffers.IsAMessageType (typeof(Krpc.Response)));
        ...
        {
            Assert.IsFalse (ProtocolBuffers.IsAnEnumType (typeof(Krpc.Request)));
            Assert.IsFalse (ProtocolBuffers.IsAnEnumType (typeof(Krpc.Response)));
        ...
        public void IsAValueType ()
        {
            ...
            Assert.IsFalse (ProtocolBuffers.IsAValueType (typeof(Krpc.Request)));
            Assert.IsFalse (ProtocolBuffers.IsAValueType (typeof(Krpc.Response)));
        ...
        {
            Assert.IsTrue (ProtocolBuffers.IsAValidType (typeof(Krpc.Request)));
            Assert.IsTrue (ProtocolBuffers.IsAValidType (typeof(Krpc.Response)));
