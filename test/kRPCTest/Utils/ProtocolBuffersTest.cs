...
namespace KRPCTest.Utils
{
    ...
    public class ProtocolBuffersTest
    {
        ...
        public void GetMessageTypeName ()
        {
            ...
            Assert.Throws<ArgumentException> (() => ProtocolBuffers.GetMessageTypeName (typeof(KRPC.Schema.Test.TestEnum)));
        ...
        {
            Assert.AreEqual ("Test.TestEnum", ProtocolBuffers.GetEnumTypeName (typeof(KRPC.Schema.Test.TestEnum)));
        ...
        public void GetValueTypeName ()
        {
            ...
            Assert.Throws<ArgumentException> (() => ProtocolBuffers.GetValueTypeName (typeof(KRPC.Schema.Test.TestEnum)));
        ...
        public void IsAMessageType ()
        {
            ...
            Assert.IsFalse (ProtocolBuffers.IsAMessageType (typeof(KRPC.Schema.Test.TestEnum)));
        ...
        public void IsAnEnumType ()
        {
            ...
            Assert.IsTrue (ProtocolBuffers.IsAnEnumType (typeof(KRPC.Schema.Test.TestEnum)));
        ...
        public void IsAValueType ()
        {
            ...
            Assert.IsFalse (ProtocolBuffers.IsAValueType (typeof(KRPC.Schema.Test.TestEnum)));
        ...
        public void IsAValidType ()
        {
            ...
            Assert.IsTrue (ProtocolBuffers.IsAValidType (typeof(KRPC.Schema.Test.TestEnum)));
        ...
        public void ReadValue ()
        {
            ...
            Assert.Throws<InvalidProtocolBufferException> (() => ProtocolBuffers.ReadValue (FromHex (""), typeof(bool)));
        }
