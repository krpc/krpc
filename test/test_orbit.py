...
class TestOrbit(testingtools.TestCase):
    ...
    def test_orbit_kerbin(self):
        ...
        self.assertClose(1929.1, self.ksp.Orbit.TimeToApoapsis, error=0.5)
        self.assertClose(469.9, self.ksp.Orbit.TimeToPeriapsis, error=0.5)
    ...
    def test_orbit_bop(self):
        ...
        self.assertClose(1593.33, self.ksp.Orbit.TimeToApoapsis, error=0.5)
        self.assertClose(7570.88, self.ksp.Orbit.TimeToPeriapsis, error=0.5)
    ...
    def test_orbit_mun_escape_soi(self):
        ...
        self.assertClose(29017.6, self.ksp.Orbit.TimeToApoapsis, error=0.5)
        self.assertClose(658.6, self.ksp.Orbit.TimeToPeriapsis, error=0.5)
    ...
    def test_orbit_minmus_parabolic(self):
        ...
        self.assertClose(0, self.ksp.Orbit.TimeToApoapsis, error=0.5)
        self.assertClose(1024.43, self.ksp.Orbit.TimeToPeriapsis, error=0.5)
