...
class TestContracts(krpctest.TestCase):
    ...
    def test_contract(self):
        ...
        self.assertEqual("FinePrint.Contracts.ExplorationContract", contract.type)
        ...
        self.assertEqual(
            "We need to achieve a stable orbit around Kerbin. "
    ...
    def test_child_parameters(self):
        ...
        self.assertEqual(1, len(contract.parameters))
        parameter = contract.parameters[0]
        self.assertEqual('Test RT-10 "Hammer" Solid Fuel Booster', parameter.title)
        self.assertEqual(2, len(parameter.children))
        self.assertEqual(
            ["Kerbin", "Launch Site"], [x.title for x in parameter.children]
        )
    ...
    def test_active_contracts(self):
        ...
        self.assertCountEqual(["Orbit Kerbin!"], [x.title for x in contracts])
    ...
    def test_offered_contracts(self):
        ...
        self.assertEqual(
            "Conduct a focused observational survey of Kerbin.", contract.title
        )
    ...
    def test_completed_contracts(self):
        ...
        self.assertCountEqual(
            ["Launch our first vessel!"], [x.title for x in contracts]
        )
        contract = contracts[0]
        self.assertEqual("FinePrint.Contracts.ExplorationContract", contract.type)
